...
def test_step07_fit_gating_relaxes_to_secondary_when_needed() -> None:
    ...
    scored_topics = [
        {"fit_assessment": {"fit_score": 0.72, "fit_tier": "excluded", "hard_exclusion_reason": None, "fit_threshold_used": None}},
        {"fit_assessment": {"fit_score": 0.68, "fit_tier": "excluded", "hard_exclusion_reason": None, "fit_threshold_used": None}},
        {"fit_assessment": {"fit_score": 0.65, "fit_tier": "excluded", "hard_exclusion_reason": None, "fit_threshold_used": None}},
        {"fit_assessment": {"fit_score": 0.63, "fit_tier": "excluded", "hard_exclusion_reason": None, "fit_threshold_used": None}},
        {"fit_assessment": {"fit_score": 0.61, "fit_tier": "excluded", "hard_exclusion_reason": None, "fit_threshold_used": None}},
        {"fit_assessment": {"fit_score": 0.59, "fit_tier": "excluded", "hard_exclusion_reason": None, "fit_threshold_used": None}},
    ]
