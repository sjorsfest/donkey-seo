...
# Step-number mapping used for learning applicability metadata.
LEGACY_STEP_TO_CAPABILITY: dict[int, str] = {
    1: CAPABILITY_SEED_GENERATION,
    2: CAPABILITY_KEYWORD_EXPANSION,
    3: CAPABILITY_KEYWORD_EXPANSION,
    4: CAPABILITY_INTENT_CLASSIFICATION,
    5: CAPABILITY_CLUSTERING,
    6: CAPABILITY_PRIORITIZATION,
    7: CAPABILITY_SERP_VALIDATION,
}
